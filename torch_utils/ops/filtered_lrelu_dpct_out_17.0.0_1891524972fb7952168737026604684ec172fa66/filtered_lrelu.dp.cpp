...
template <class T, class index_t, bool signWrite, bool signRead, int SH,
    ...
    */
    /*
    DPCT1007:21: Migration of cudaLaunchKernel is not supported.
    */
  ...
  AT_CUDA_CHECK();
    ...
    /*
    DPCT1027:24: The call to cudaFuncSetCacheConfig was replaced with 0 because
    ...
    */
    ...
    if (dynamicSharedKB) // Need dynamically allocated shared memory?
        /*
        DPCT1007:25: Migration of cudaFuncSetAttribute is not supported.
        */
        AT_CUDA_CHECK(cudaFuncSetAttribute(
            ...
            dynamicSharedKB << 10));
    /*
    DPCT1027:26: The call to cudaFuncSetSharedMemConfig was replaced with 0
    ...
    */
    ...
    for (int zofs=0; zofs < gz; zofs += maxSubGz) // Do multiple launches if gz is too big.
    {
        ...
        */
        /*
        DPCT1007:22: Migration of cudaLaunchKernel is not supported.
        */
    ((sycl::queue *)(at::cuda::getCurrentCUDAStream()))
        ->submit([&](sycl::handler &cgh) {
...
void run_filtered_lrelu_act_kernel(filtered_lrelu_act_kernel_params &p) try {
    ...
    */
    /*
    DPCT1007:23: Migration of cudaLaunchKernel is not supported.
    */
  {
