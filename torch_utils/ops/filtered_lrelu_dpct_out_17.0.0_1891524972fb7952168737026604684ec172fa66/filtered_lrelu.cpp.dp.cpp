    ...
    int up, int down, int px0, int px1, int py0, int py1, int sx, int sy, float gain, float slope, float clamp, bool flip_filters, bool writeSigns)
{
    ...
    */
    /*
    DPCT1009:24: SYCL uses exceptions to report errors and does not use the
    ...
    */
    "cudaGetErrorString is not supported" /*cudaGetErrorString(AT_CUDA_CHECK(cudaDeviceGetAttribute(&maxSharedBytes,
    ...
    */
    /*
    DPCT1009:28: SYCL uses exceptions to report errors and does not use the
    error codes. The original code was commented out and a warning string was
    inserted. You need to rewrite this code.
    */
    /*
    DPCT1064:29: Migrated cudaGetErrorString call is used in a macro/template
    ...
    */
    /*
    DPCT1000:26: Error handling if-stmt was detected but could not be rewritten.
    */
    "cudaGetErrorString is not supported" /*cudaGetErrorString(AT_CUDA_CHECK(cudaLaunchKernel(spec.setup,
                                             1, 1024, args, 0,
    ...
    */
    /*
    DPCT1064:34: Migrated cudaGetErrorString call is used in a macro/template
    definition and may not be valid for all macro/template uses. Adjust the
    code.
    */
    /*
    ...
    */
    if (writeSigns &&
        !readSigns) "cudaGetErrorString is not supported" /*cudaGetErrorString(AT_CUDA_CHECK((copy_filters<true,
    ...
    */
    /*
    DPCT1009:38: SYCL uses exceptions to report errors and does not use the
    error codes. The original code was commented out and a warning string was
    inserted. You need to rewrite this code.
    */
    /*
    DPCT1064:39: Migrated cudaGetErrorString call is used in a macro/template
    definition and may not be valid for all macro/template uses. Adjust the
    code.
    */
    /*
    ...
    */
        ...
        !writeSigns &&
        readSigns) "cudaGetErrorString is not supported" /*cudaGetErrorString(AT_CUDA_CHECK((copy_filters<false,
                                                            true
                                                            >(at::cuda::getCurrentCUDAStream()))))*/
        ;
    /*
    ...
    */
    /*
    DPCT1009:43: SYCL uses exceptions to report errors and does not use the
    error codes. The original code was commented out and a warning string was
    inserted. You need to rewrite this code.
    */
    /*
    DPCT1064:44: Migrated cudaGetErrorString call is used in a macro/template
    definition and may not be valid for all macro/template uses. Adjust the
    code.
    */
    /*
    ...
    */
    /*
    DPCT1009:49: SYCL uses exceptions to report errors and does not use the
    error codes. The original code was commented out and a warning string was
    inserted. You need to rewrite this code.
    */
    /*
    DPCT1064:50: Migrated cudaGetErrorString call is used in a macro/template
    definition and may not be valid for all macro/template uses. Adjust the
    code.
    */
    /*
    DPCT1001:45: The statement could not be removed.
    */
    /*
    DPCT1000:46: Error handling if-stmt was detected but could not be rewritten.
    */
    /*
    ...
    */
    "cudaGetErrorString is not supported" /*cudaGetErrorString(AT_CUDA_CHECK(cudaFuncSetCacheConfig(spec.exec,
    ...
    if (spec.dynamicSharedKB) // Need dynamically allocated shared memory?
        ...
        */
        /*
        DPCT1064:56: Migrated cudaGetErrorString call is used in a
        ...
        */
        /*
        DPCT1007:53: Migration of cudaFuncSetAttribute is not supported.
        */
        "cudaGetErrorString is not supported" /*cudaGetErrorString(AT_CUDA_CHECK(cudaFuncSetAttribute(spec.exec,
    ...
    */
    /*
    DPCT1009:61: SYCL uses exceptions to report errors and does not use the
    error codes. The original code was commented out and a warning string was
    inserted. You need to rewrite this code.
    */
    /*
    DPCT1064:62: Migrated cudaGetErrorString call is used in a macro/template
    definition and may not be valid for all macro/template uses. Adjust the
    code.
    */
    /*
    DPCT1001:57: The statement could not be removed.
    */
    /*
    DPCT1000:58: Error handling if-stmt was detected but could not be rewritten.
    */
    /*
    ...
    devices.
    */
    "cudaGetErrorString is not supported" /*cudaGetErrorString(AT_CUDA_CHECK(cudaFuncSetSharedMemConfig(spec.exec,
    ...
    for (int zofs=0; zofs < gz; zofs += maxSubGz) // Do multiple launches if gz is too big.
    {
        ...
        /*
        DPCT1007:1: Migration of cudaLaunchKernel is not supported.
        */
        /*
        ...
        */
        /*
        DPCT1009:66: SYCL uses exceptions to report errors and does not use the
        error codes. The original code was commented out and a warning string
        was inserted. You need to rewrite this code.
        */
        /*
        DPCT1064:67: Migrated cudaGetErrorString call is used in a
        macro/template definition and may not be valid for all macro/template
        uses. Adjust the code.
        */
        /*
        ...
        */
        /*
        DPCT1000:64: Error handling if-stmt was detected but could not be
        rewritten.
        */
        "cudaGetErrorString is not supported" /*cudaGetErrorString(AT_CUDA_CHECK(cudaLaunchKernel(spec.exec,
                                                 dim3(gx, gy, subGz), bx, args,
                                                 spec.dynamicSharedKB << 10,
                                                 at::cuda::getCurrentCUDAStream())))*/
            ;
    }
...
static torch::Tensor filtered_lrelu_act(torch::Tensor x, torch::Tensor si, int sx, int sy, float gain, float slope, float clamp, bool writeSigns)
{
    ...
    // Launch.
    /*
    DPCT1007:2: Migration of cudaLaunchKernel is not supported.
    */
    /*
    ...
    */
    /*
    DPCT1009:71: SYCL uses exceptions to report errors and does not use the
    error codes. The original code was commented out and a warning string was
    inserted. You need to rewrite this code.
    */
    /*
    DPCT1064:72: Migrated cudaGetErrorString call is used in a macro/template
    definition and may not be valid for all macro/template uses. Adjust the
    code.
    */
    /*
    ...
    */
    /*
    DPCT1000:69: Error handling if-stmt was detected but could not be rewritten.
    */
    "cudaGetErrorString is not supported" /*cudaGetErrorString(AT_CUDA_CHECK(cudaLaunchKernel(func,
                                             dim3(gx, gy, gz), bx, args, 0,
                                             at::cuda::getCurrentCUDAStream())))*/
        ;
    return so;
}
