...
def subprocess_fn(rank, c, temp_dir):
    ...
    # Init torch_utils.
    sync_device = torch.device('xpu', rank) if c.num_gpus > 1 else None
...
@click.option('--kimg',         help='Total training duration', metavar='KIMG',                 type=click.IntRange(min=0), default=25000, show_default=True)
